...
class LocationInputView: UIView {
    ...
    private lazy var destinationLocationTextField: UITextField = {
        let tf = UITextField()
        tf.placeholder = "Entern a destination"
    ...
    func addAllSubViews() {
        let subviews = [
            backButton, titleLabel, startLocationIndicatorView, linkingView, destinationIndicatorView, startingLocationTextField, destinationLocationTextField
        ]
        subviews.forEach {
